...
var themeFunctionality = {
	init: function () {
		 ...
		 */
		$.loadScript(theme_path + 'extensions/breadcrumbs/collapsing/collapsing-breadcrumbs.js?v=' + new Date().getTime());
...
MJB 2022/10/13 modified to trigger on 'mousedown' instead of 'click" which was triggering multple times
		 ...
		 */
		$.loadScript(theme_path + 'extensions/product-layout/ajax-add-to-cart.js?v=1.05');
